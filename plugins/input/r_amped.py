				...
				if amped_region.midi_notes: 
					...
					for amped_note in amped_region.midi_notes:
						if amped_note['position'] >= 0:
							cvpj_notelist.add_r(amped_note['position'], amped_note['length'], amped_note['key']-60, amped_note['velocity']/127, None)
							if 'mute' in amped_note:
								if amped_note['mute']: cvpj_notelist.last_flag('disabled')
