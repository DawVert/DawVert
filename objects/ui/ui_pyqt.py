...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_5.addWidget(self.AutoDetectButton)
        ...
        self.ConfigMain = QtWidgets.QPushButton(parent=self.ConfigArea)
        self.ConfigMain.setObjectName("ConfigMain")
        self.horizontalLayout.addWidget(self.ConfigMain)
        self.ConfigSoundFont = QtWidgets.QPushButton(parent=self.ConfigArea)
        self.ConfigSoundFont.setObjectName("ConfigSoundFont")
        self.horizontalLayout.addWidget(self.ConfigSoundFont)
        self.ConfigExtPlug = QtWidgets.QPushButton(parent=self.ConfigArea)
        self.ConfigExtPlug.setObjectName("ConfigExtPlug")
        self.horizontalLayout.addWidget(self.ConfigExtPlug)
        self.ConfigConversion = QtWidgets.QPushButton(parent=self.ConfigArea)
        self.ConfigConversion.setObjectName("ConfigConversion")
        self.horizontalLayout.addWidget(self.ConfigConversion)
        self.ConfigOutput = QtWidgets.QPushButton(parent=self.ConfigArea)
        self.ConfigOutput.setObjectName("ConfigOutput")
        self.horizontalLayout.addWidget(self.ConfigOutput)
        self.ConfigInput = QtWidgets.QPushButton(parent=self.ConfigArea)
        self.ConfigInput.setObjectName("ConfigInput")
        self.horizontalLayout.addWidget(self.ConfigInput)
        self.verticalLayout_7.addLayout(self.horizontalLayout)
        self.AreaInteract.addWidget(self.ConfigArea)
        ...
        self.verticalLayout_8.addWidget(self.PluginScanButton)
        ...
        self.verticalLayout_8.addWidget(self.PluginScanStatus)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ConfigMain.setText(_translate("MainWindow", "Main"))
        self.ConfigSoundFont.setText(_translate("MainWindow", "Soundfonts"))
        self.ConfigExtPlug.setText(_translate("MainWindow", "External Plugins"))
        self.ConfigConversion.setText(_translate("MainWindow", "Conversion"))
        self.ConfigOutput.setText(_translate("MainWindow", "Output Plugin"))
        self.ConfigInput.setText(_translate("MainWindow", "Input Plugin"))
