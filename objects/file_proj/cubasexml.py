...
globalstate.classes['UTextEditorBuffer'] = class_UTextEditorBuffer

@dataclass
class class_ApplicationVersion:
	idnum: int = 0
	application: str = 'cubasexml'
...
globalstate.classes['Application Version'] = class_ApplicationVersion

@dataclass
class class_UColorSet:
	idnum: int = 0
	setname: str = 'Event Colors'
	c_set: cubasexml_list_dict = field(default_factory=cubasexml_list_dict)
	c_defset: cubasexml_list_dict = field(default_factory=cubasexml_list_dict)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['UColorSet'] = class_UColorSet
...
class class_TrackParaEffect:
	...
	isinsert: int = 1
	playinstop: int = 0
	inputs: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	outputs: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
...
globalstate.classes['TrackParaEffect'] = class_TrackParaEffect
...
globalstate.classes['TControllerLaneDef'] = class_TControllerLaneDef
...
globalstate.classes['Segmentation'] = class_Segmentation
...
class class_StepEnvelopeGroup:
	...
	envelope: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['StepEnvelopeGroup'] = class_StepEnvelopeGroup
...
globalstate.classes['StepEnvelope'] = class_StepEnvelope
...
globalstate.classes['QCDestinationValue'] = class_QCDestinationValue
...
globalstate.classes['NoteEvent'] = class_NoteEvent
...
globalstate.classes['CmString'] = class_CmString
...
class class_GTreeEntry:
	...
	name: str = ''
	v_id: int = 0
	subentries: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['GTreeEntry'] = class_GTreeEntry

@dataclass
class class_CmLinkedList:
	idnum: int = 0
	ownership: int = 1
	obj: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['CmLinkedList'] = class_CmLinkedList
...
globalstate.classes['FNPath'] = class_FNPath
...
globalstate.classes['CmVariant'] = class_CmVariant
...
globalstate.classes['PStepData'] = class_PStepData
...
globalstate.classes['PGridDefinition'] = class_PGridDefinition
...
globalstate.classes['MRegionMarker'] = class_MRegionMarker
...
globalstate.classes['MHitPointEvent'] = class_MHitPointEvent
...
globalstate.classes['MParamEvent'] = class_MParamEvent

@dataclass
class class_MLinearInterpolator:
	idnum: int = 0
	points: cubasexml_list_dict = field(default_factory=cubasexml_list_dict)
	xmin: float = 0.0
	xmax: float = 1.0
	ymin: float = 0.0
	ymax: float = 1.0
...
globalstate.classes['MLinearInterpolator'] = class_MLinearInterpolator
...
globalstate.classes['MFadeOut'] = class_MFadeOut
...
globalstate.classes['MAutomationTrackEvent'] = class_MAutomationTrackEvent
...
class class_MAutomationNode:
	...
	tracks: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	track_device: obj_pointer = field(default_factory=obj_pointer)
	expanded: int = 0
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
...
globalstate.classes['MAutomationNode'] = class_MAutomationNode
...
globalstate.classes['PTrackIconData'] = class_PTrackIconData
...
globalstate.classes['MPlayRangeListItem'] = class_MPlayRangeListItem
...
globalstate.classes['MAutoFadeSetting'] = class_MAutoFadeSetting
...
globalstate.classes['MPlayRangeEvent'] = class_MPlayRangeEvent
...
globalstate.classes['MListNode'] = class_MListNode
...
class class_MAutoListNode:
	...
	def make_xml(self, xmlobj):
		makeval__dict(xmlobj, 'Domain', self.domain.to_dict())
		if self.events: makeval__list(xmlobj, 'Events', self.events)
globalstate.classes['MAutoListNode'] = class_MAutoListNode
...
globalstate.classes['MTrack'] = class_MTrack
...
globalstate.classes['MDeviceTrackEvent'] = class_MDeviceTrackEvent
...
globalstate.classes['MAutomationTrack'] = class_MAutomationTrack
...
globalstate.classes['PLaneConfig'] = class_PLaneConfig
...
globalstate.classes['CmArray'] = class_CmArray

@dataclass
class class_MPlayOrderList:
	idnum: int = 0
	po_listname: str = ''
	po_listitems: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['MPlayOrderList'] = class_MPlayOrderList
...
globalstate.classes['PCollectPort'] = class_PCollectPort
...
class class_PExtendedDuplicator:
	...
	def make_xml(self, xmlobj):
		...
		makeval__string(xmlobj, 'Port', self.port, 1)
globalstate.classes['PExtendedDuplicator'] = class_PExtendedDuplicator
...
class class_PQuickControls:
	...
	classids: cubasexml_list_string = field(default_factory=cubasexml_list_string)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['PQuickControls'] = class_PQuickControls
...
globalstate.classes['MGridQuantize'] = class_MGridQuantize
...
class class_MTransposeTrackNode:
	...
	def make_xml(self, xmlobj):
		makeval__string(xmlobj, 'Name', self.name, 1)
		makeval__dict(xmlobj, 'Domain', self.domain.to_dict())
globalstate.classes['MTransposeTrackNode'] = class_MTransposeTrackNode
...
globalstate.classes['MTransposeTrackEvent'] = class_MTransposeTrackEvent

@dataclass
class class_FilterDefaults:
	idnum: int = 0
	categories: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	flags: int = 0
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
	...
	def make_xml(self, xmlobj):
		...
		makeval__int(xmlobj, 'Flags', self.flags)
globalstate.classes['FilterDefaults'] = class_FilterDefaults
...
class class_GTree:
	...
	def make_xml(self, xmlobj):
		...
		makeval__int(xmlobj, 'Flags', self.flags)
globalstate.classes['GTree'] = class_GTree
...
globalstate.classes['MInstrumentTrack'] = class_MInstrumentTrack
...
class class_MInstrumentTrackEvent:
	...
	def make_xml(self, xmlobj):
		...
		makeval__obj(xmlobj, 'Automation', self.automation)
globalstate.classes['MInstrumentTrackEvent'] = class_MInstrumentTrackEvent
...
class class_MPlayRangeTrackEvent:
	...
	additional_attributes: dict = field(default_factory=dict)
	track_device: class_MTrack = field(default_factory=class_MTrack)
	po_listbase: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
...
globalstate.classes['MPlayRangeTrackEvent'] = class_MPlayRangeTrackEvent
...
globalstate.classes['MTimeSignatureEvent'] = class_MTimeSignatureEvent

@dataclass
class class_MSignatureTrackEvent:
	idnum: int = 0
	signatureevent: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['MSignatureTrackEvent'] = class_MSignatureTrackEvent
...
globalstate.classes['MTempoEvent'] = class_MTempoEvent

@dataclass
class class_MTempoTrackEvent:
	idnum: int = 0
	tempoevent: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
...
globalstate.classes['MTempoTrackEvent'] = class_MTempoTrackEvent
...
class class_MTrackList:
	...
	def add_track(self, classname):
		...
		return o
globalstate.classes['MTrackList'] = class_MTrackList

@dataclass
class class_PControllerLaneSetup:
	idnum: int = 0
	laneinfo: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['PControllerLaneSetup'] = class_PControllerLaneSetup

@dataclass
class class_PDrumMapPool:
	idnum: int = 0
	drum_map: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['PDrumMapPool'] = class_PDrumMapPool
...
class class_PDrumMap:
	...
	order: cubasexml_list_int = field(default_factory=cubasexml_list_int)
...
globalstate.classes['PDrumMap'] = class_PDrumMap

@dataclass
class class_PInsVeloPreset:
	idnum: int = 0
	velocities: cubasexml_list_int = field(default_factory=cubasexml_list_int)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['PInsVeloPreset'] = class_PInsVeloPreset
...
class class_PPatternBank:
	...
	lanestyle: int = 0
	lanetopitchmap: cubasexml_list_int = field(default_factory=cubasexml_list_int)
	mutestates: dict = field(default_factory=dict)
	solostates: dict = field(default_factory=dict)
	usedpatterns: cubasexml_list_int = field(default_factory=cubasexml_list_int)
	patterns: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
		if 'Name' in obj_data: self.name = obj_data['Name']
...
globalstate.classes['PPatternBank'] = class_PPatternBank
...
class class_PPattern:
	...
	flamvel3c: float = 0
	nrlanes: int = 128
	laneconfig: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	stepdata: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	activesteps: int = 3
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
...
globalstate.classes['PPattern'] = class_PPattern
...
globalstate.classes['PStepDesigner2'] = class_PStepDesigner2
...
globalstate.classes['PPool'] = class_PPool
...
globalstate.classes['LastAppliedFileInfo'] = class_LastAppliedFileInfo
...
class class_PMidiEffectBase:
	...
	def make_xml(self, xmlobj):
		...
		makeval__list(xmlobj, 'Inputs', self.inputs)
		makeval__list(xmlobj, 'Outputs', self.outputs)
globalstate.classes['PMidiEffectBase'] = class_PMidiEffectBase
...
globalstate.classes['Root of Engine'] = class_Root_of_Engine
...
class class_MTransposeEvent:
	...
	def from_seqobj(self, seqobj):
		...
		if 'Flags' in obj_data: self.flags = obj_data['Flags']
		if 'Length' in obj_data: self.length = obj_data['Length']
globalstate.classes['MTransposeEvent'] = class_MTransposeEvent
...
class class_PDuplicator:
	...
	def make_xml(self, xmlobj):
		xmlobj.text = ''
globalstate.classes['PDuplicator'] = class_PDuplicator
...
class class_MiniSequence:
	...
	pitches: cubasexml_list_int = field(default_factory=cubasexml_list_int)
	controllerNumbers: cubasexml_list_int = field(default_factory=cubasexml_list_int)
	controllerEvents: cubasexml_list_int = field(default_factory=cubasexml_list_int)
...
globalstate.classes['MiniSequence'] = class_MiniSequence
...
globalstate.classes['Phrasor'] = class_Phrasor
...
class class_ChordProcessor:
	...
	def make_xml(self, xmlobj):
		...
		makeval__int(xmlobj, 'PresetIndex', self.presetindex)
globalstate.classes['ChordProcessor'] = class_ChordProcessor
...
class class_CmBitSet:
	...
	def make_xml(self, xmlobj):
		...
		pass
globalstate.classes['CmBitSet'] = class_CmBitSet
...
globalstate.classes['Attributes'] = class_Attributes
...
class class_PEventReader:
	...
	def make_xml(self, xmlobj):
		xmlobj.text = ''
globalstate.classes['PEventReader'] = class_PEventReader
...
globalstate.classes['Project'] = class_Project

@dataclass
class class_MTrackVariationCollection:
	idnum: int = 0
	ownership: int = 1
	obj: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
	...
	def make_xml(self, xmlobj):
		makeval__int(xmlobj, 'ownership', self.ownership)
		if self.obj: makeval__list(xmlobj, 'obj', self.obj)
globalstate.classes['MTrackVariationCollection'] = class_MTrackVariationCollection

@dataclass
class class_MTrackVariation:
	idnum: int = 0
	name: str = ''
	variationID: int = 0
	def from_seqobj(self, seqobj):
		...
		obj_data = seqobj.obj_data
		if 'name' in obj_data: self.name = obj_data['name']
		if 'variationID' in obj_data: self.variationID = obj_data['variationID']
	def make_xml(self, xmlobj):
		makeval__string(xmlobj, 'name', self.name, 1)
		makeval__int(xmlobj, 'variationID', self.variationID)
globalstate.classes['MTrackVariation'] = class_MTrackVariation

@dataclass
class class_PChordTrackParam:
	idnum: int = 0
	flags: int = 0
	mapMode: int = 0
	liveMapMode: int = 0
	liveMapInput: int = 0
	selectedSingleVoiceIndex: int = 0
	voicingLib: str = 'chordtrack'
	voicingSetup: dict = field(default_factory=dict)
	uniqueID: int = 0
	catchRange: int = 0
	chordPadVoicingModuleIndex: int = 0
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
		if 'flags' in obj_data: self.flags = obj_data['flags']
		if 'mapMode' in obj_data: self.mapMode = obj_data['mapMode']
		if 'liveMapMode' in obj_data: self.liveMapMode = obj_data['liveMapMode']
		if 'liveMapInput' in obj_data: self.liveMapInput = obj_data['liveMapInput']
		if 'selectedSingleVoiceIndex' in obj_data: self.selectedSingleVoiceIndex = obj_data['selectedSingleVoiceIndex']
		if 'voicingLib' in obj_data: self.voicingLib = obj_data['voicingLib']
		if 'voicingSetup' in obj_data: self.voicingSetup = obj_data['voicingSetup']
		if 'uniqueID' in obj_data: self.uniqueID = obj_data['uniqueID']
		if 'catchRange' in obj_data: self.catchRange = obj_data['catchRange']
		if 'chordPadVoicingModuleIndex' in obj_data: self.chordPadVoicingModuleIndex = obj_data['chordPadVoicingModuleIndex']
	def make_xml(self, xmlobj):
		makeval__int(xmlobj, 'flags', self.flags)
		makeval__int(xmlobj, 'mapMode', self.mapMode)
		makeval__int(xmlobj, 'liveMapMode', self.liveMapMode)
		makeval__int(xmlobj, 'liveMapInput', self.liveMapInput)
		makeval__int(xmlobj, 'selectedSingleVoiceIndex', self.selectedSingleVoiceIndex)
		makeval__string(xmlobj, 'voicingLib', self.voicingLib, 1)
		makeval__dict(xmlobj, 'voicingSetup', self.voicingSetup)
		makeval__int(xmlobj, 'uniqueID', self.uniqueID)
		makeval__int(xmlobj, 'catchRange', self.catchRange)
		makeval__int(xmlobj, 'chordPadVoicingModuleIndex', self.chordPadVoicingModuleIndex)
globalstate.classes['PChordTrackParam'] = class_PChordTrackParam

@dataclass
class class_DynamicsParam:
	idnum: int = 0
	type: int = 0
	controller1Start: float = 0
	controller2Start: float = 0
	velocityStart: int = 0
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
		if 'type' in obj_data: self.type = obj_data['type']
		if 'controller1Start' in obj_data: self.controller1Start = obj_data['controller1Start']
		if 'controller2Start' in obj_data: self.controller2Start = obj_data['controller2Start']
		if 'velocityStart' in obj_data: self.velocityStart = obj_data['velocityStart']
	def make_xml(self, xmlobj):
		makeval__int(xmlobj, 'type', self.type)
		makeval__float(xmlobj, 'controller1Start', self.controller1Start)
		makeval__float(xmlobj, 'controller2Start', self.controller2Start)
		makeval__int(xmlobj, 'velocityStart', self.velocityStart)
globalstate.classes['DynamicsParam'] = class_DynamicsParam

@dataclass
class class_SNADynamicDefinition:
	idnum: int = 0
	param: dict = field(default_factory=dict)
	usage: int = 0
	controllertype1: int = 0
	controllertype2: int = 0
	flags: int = 0
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
		if 'param' in obj_data: self.param = obj_data['param']
		if 'usage' in obj_data: self.usage = obj_data['usage']
		if 'controllertype1' in obj_data: self.controllertype1 = obj_data['controllertype1']
		if 'controllertype2' in obj_data: self.controllertype2 = obj_data['controllertype2']
		if 'flags' in obj_data: self.flags = obj_data['flags']
	def make_xml(self, xmlobj):
		makeval__dict(xmlobj, 'param', self.param)
		makeval__int(xmlobj, 'usage', self.usage)
		makeval__float(xmlobj, 'controllertype1', self.controllertype1)
		makeval__float(xmlobj, 'controllertype2', self.controllertype2)
		makeval__int(xmlobj, 'flags', self.flags)
globalstate.classes['SNADynamicDefinition'] = class_SNADynamicDefinition

@dataclass
class class_PSNAParamSelectionEntry:
	editable: int = 1
	visible: int = 0
	colorId: int = 0
	name: str = ''
	...
	vmin: float = 0
	vmax: float = 1
	isHorizontalToTuningSpecial: int = 0
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
		if 'editable' in obj_data: self.editable = obj_data['editable']
		if 'visible' in obj_data: self.visible = obj_data['visible']
		if 'colorId' in obj_data: self.colorId = obj_data['colorId']
		if 'name' in obj_data: self.name = obj_data['name']
		if 'snaType' in obj_data: self.snaType = obj_data['snaType']
		if 'snaParam' in obj_data: self.snaParam = obj_data['snaParam']
		if 'inputType' in obj_data: self.inputType = obj_data['inputType']
		if 'inputSubtype' in obj_data: self.inputSubtype = obj_data['inputSubtype']
		if 'min' in obj_data: self.vmin = obj_data['min']
		if 'max' in obj_data: self.vmax = obj_data['max']
		if 'isHorizontalToTuningSpecial' in obj_data: self.isHorizontalToTuningSpecial = obj_data['isHorizontalToTuningSpecial']
	def make_xml(self, xmlobj):
		makeval__int(xmlobj, 'editable', self.editable)
		makeval__int(xmlobj, 'visible', self.visible)
		makeval__int(xmlobj, 'colorId', self.colorId)
		makeval__string(xmlobj, 'name', self.name, 1)
		makeval__int(xmlobj, 'snaType', self.snaType)
		makeval__int(xmlobj, 'snaParam', self.snaParam)
		makeval__int(xmlobj, 'inputType', self.inputType)
		makeval__int(xmlobj, 'inputSubtype', self.inputSubtype)
		makeval__float(xmlobj, 'min', self.vmin)
		makeval__float(xmlobj, 'max', self.vmax)
		makeval__int(xmlobj, 'isHorizontalToTuningSpecial', self.isHorizontalToTuningSpecial)
globalstate.classes['PSNAParamSelectionEntry'] = class_PSNAParamSelectionEntry

@dataclass
class class_PSNAParamSelection:
	idnum: int = 0
	flags: int = 0
	Entries: cubasexml_list_obj = field(default_factory=cubasexml_list_obj)
	def from_seqobj(self, seqobj):
		self.idnum = seqobj.obj_id
		obj_data = seqobj.obj_data
		if 'flags' in obj_data: self.flags = obj_data['flags']
		if 'Entries' in obj_data: self.Entries.setvals(obj_data['Entries'])
	def make_xml(self, xmlobj):
		makeval__list(xmlobj, 'Entries', self.Entries)
		makeval__int(xmlobj, 'flags', self.flags)
globalstate.classes['PSNAParamSelection'] = class_MTrackVariationCollection

@dataclass
class class_MFolderTrack:
	idnum: int = 0
	flags: int = 0
	start: float = 0.0
	length: float = 1800
	...
	def from_seqobj(self, seqobj):
		...
		if 'Track Device' in obj_data: self.track_device = obj_data['Track Device']
		if 'Expanded' in obj_data: self.expanded = obj_data['Expanded']
		if 'Solo' in obj_data: self.solo = obj_data['Solo']
	def make_xml(self, xmlobj):
		makeval__int(xmlobj, 'Flags', self.flags)
		makeval__float(xmlobj, 'Start', self.start)
		makeval__float(xmlobj, 'Length', self.length)
		...
		makeval__obj(xmlobj, 'Track Device', self.track_device)
		makeval__int(xmlobj, 'Expanded', self.expanded)
		makeval__int(xmlobj, 'Solo', self.solo)
globalstate.classes['MFolderTrack'] = class_MFolderTrack

from objects.file_proj._cubasexml import class_midi
from objects.file_proj._cubasexml import class_audio
from objects.file_proj._cubasexml import class_stmedia

# ================================================ MAIN ================================================

classesmake = dict([(x[1], x[0]) for x in globalstate.classes.items()])
...
class cubasexml_project:
	def __init__(self):
		self.tracks = []
		self.ExternalRouting = []
		self.Setup = []
		self.objects = {}
	...
	def load_from_file(self, filename):
		...
		for x in x_root:
			if x.tag == 'list':
				listname = x.get('name')
				if listname=='track': self.tracks = getval__list(x)
...
class sequel_project:
	...
	def fsck_file(self, filename):
		...
		for x in globalstate.debug_allp:
			if x not in globalstate.debug_alld:
				print('Pointer Target not found', x)
				exit()
		#for x in globalstate.debug_allp:
		#	if x in globalstate.debug_alld: 
		#		del copyglobalstate.debug_allp[x]
		#print(list(copyglobalstate.debug_allp))
